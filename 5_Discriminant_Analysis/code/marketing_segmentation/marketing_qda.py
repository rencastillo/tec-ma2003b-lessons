...
for i, segment in enumerate(segments):
    ...
    plt.axvline(np.mean(probs), color='red', linestyle='--', linewidth=2,
...
if qda_accuracy > lda_accuracy:
    print("QDA outperformed LDA, suggesting different covariance structures across segments")
else:
    print("LDA performed similarly or better, suggesting equal covariance assumption is reasonable")
