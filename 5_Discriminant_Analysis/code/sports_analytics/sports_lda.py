...
features = ['speed', 'endurance', 'strength', 'technique', 'agility',
           'power', 'consistency']
...
for i, category in enumerate(categories):
    ...
    plt.scatter(lda_scores_df.loc[mask, 'LD1'],
               ...
               c=colors[i], label=f'{category} Athletes',
...
for i, category in enumerate(categories):
    plt.bar(x + i*width, centroids_original[i, :4], width,
            label=f'{category} Athletes', alpha=0.7, color=colors[i])
