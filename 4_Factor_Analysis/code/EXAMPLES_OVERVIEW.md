...
This directory contains four comprehensive PCA/Factor Analysis examples with synthetic but realistic datasets from different domains. Each example includes detailed data dictionaries that explain the variables, their measurement scales, and domain-specific context.
...
**Dataset**: Synthetic student assessment data with 4 variables  
**Data Dictionary**: Educational assessment metrics (MathTest, VerbalTest, SocialSkills, Leadership)

- Assessment variables: Academic and social-emotional learning measures
- Pedagogical interpretation: Direct PCA vs Factor Analysis comparison, method validation
- Educational focus: Statistical method comparison, communalities vs unique variance

### 2. Kuiper Belt Objects (`kuiper_example/`)
...
### 3. European Stock Markets (`invest_example/`)
...
### 4. Hospital Health Outcomes (`hospitals_example/`)
...
- **Correlation structures**: From pedagogical comparison (educational) to moderate (Kuiper) to very high (stocks) correlations
- **Variance explained**: Different patterns of eigenvalue distributions  
- **Interpretation challenges**: Methodological (educational), physical (orbital), economic (systematic risk), clinical (quality)
