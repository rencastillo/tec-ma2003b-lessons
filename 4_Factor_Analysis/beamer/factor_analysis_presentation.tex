...
\end{itemize}
\vspace{6pt}
% If you want the images embedded in the slides, run the script and add an \includegraphics command here pointing to ../code/invest_scree.png or ../code/invest_biplot.png
\end{frame}
