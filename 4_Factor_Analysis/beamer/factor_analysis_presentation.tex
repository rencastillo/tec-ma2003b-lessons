...
\begin{frame}
    ...
    \end{itemize}
    \vspace{6pt}
    Script: \texttt{lessons/4\_Factor\_Analysis/code/pca\_example/educational\_pca.py}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
    \vspace{6pt}
    Script: \texttt{lessons/4\_Factor\_Analysis/code/invest\_example/invest\_pca.py}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
    \vspace{6pt}
    Script: \texttt{lessons/4\_Factor\_Analysis/code/kuiper\_example/kuiper\_pca.py}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
    \vspace{6pt}
    Script: \texttt{lessons/4\_Factor\_Analysis/code/hospitals\_example/hospitals\_pca.py}
\end{frame}
