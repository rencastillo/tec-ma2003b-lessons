...
% Quick code example frame (references external snippet files)
\begin{frame}[fragile]
...
\vspace{6pt}
\lstinputlisting[language=Python,caption={PCA example (file: ../code/pca\_example.py)}]{../code/pca_example.py}
\end{frame}
